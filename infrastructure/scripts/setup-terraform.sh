...
print_next_steps() {
    ...
    echo "   a. Configure OAuth consent screen:"
    echo "      https://console.cloud.google.com/apis/credentials/consent?project=${project_id}"
    echo "   b. Create OAuth 2.0 Client ID (Web application):"
    echo "      https://console.cloud.google.com/apis/credentials?project=${project_id}"
    echo "      Add redirect URI: https://${project_id}.firebaseapp.com/__/auth/handler"
    echo "   c. Add to terraform.tfvars:"
    echo "      enable_google_signin = true"
    echo "      oauth_client_id     = \"YOUR_CLIENT_ID\""
    echo "      oauth_client_secret = \"YOUR_SECRET\""
    echo "   d. Run: terraform -chdir=infrastructure/terraform apply"
    echo ""
