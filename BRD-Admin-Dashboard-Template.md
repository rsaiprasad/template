...
â”œâ”€â”€ biome.json                   # Biome config (shared)
...
Also update the Permission type in `packages/shared/src/types/permission.ts` to include `'orders'` as a resource and the new permission strings.
